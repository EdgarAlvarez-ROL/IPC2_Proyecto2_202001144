        ...
        def return_dataD(self):
            ...
            if self.root is None:
                ...
                while apuntador is not None:
                    ...
                    data += str(apuntador.elemento.getFila()) + "L"
                    data += str(apuntador.elemento.getColumna()) + "L"
                    data += str(apuntador.elemento.getCapacidad()) + "L"
                    apuntador = apuntador.siguiente
            return data
...
class Robot:
    def __init__(self, tipo, capacidad, nombre) -> None: #
        self.tipo = tipo
        self.capacidad = capacidad
        self.nombre = nombre
...
class lista_Robots:
    ...
    """"""
    def print_Data_ROBOTS(self,numero):
        data = ''
        if self.root is None:
            print("La lista esta vacia")
            return
            ...
            while apuntador is not None:
                if numero == 1:
                    print(apuntador.elemento.getTipo(), " ")
                elif numero == 2:
                    print(apuntador.elemento.getCapacidad(), " ")
                elif numero == 3:
                    print(apuntador.elemento.getNombre(), " ")
    ...
    """"""
    """"""
    def return_infoEspecifica_ROBOTS(self,numero):
        data = ''
        if self.root is None:
            print("La lista esta vacia")
            return
            ...
            while apuntador is not None:
                if numero == 1:
                    data += apuntador.elemento.getTipo() + " "
                elif numero == 2:
                    data += str(apuntador.elemento.getCapacidad()) + " "
                elif numero == 3:
                    data += str(apuntador.elemento.getNombre()) + " "
    ...
    """"""
    """"""
    def return_Data_ROBOT(self, nombreC):
        data = ''
        if self.root is None:
            print("La lista esta vacia")
            return
            ...
            apuntador = self.root
            while apuntador is not None:
                if (apuntador.elemento.getTipo()) == nombreC:
                    data += str(apuntador.elemento.getNombre()) + "Y"                
                    data += str(apuntador.elemento.getCapacidad()) + "Y"
                elif (apuntador.elemento.getNombre()) == nombreC:
                    # data += str(apuntador.elemento.getTipo()) + "Y"                
                    data += str(apuntador.elemento.getCapacidad())
                # print(apuntador.elemento, " ")
                apuntador = apuntador.siguiente
                # break
